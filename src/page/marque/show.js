   ...
   useEffect(() => {
    ShowInput();
             ...
             const deleteInput = (id) => {
              ...
              axios.delete(`http://localhost/Rest/marque//destroy.php?id=${id}`).then(function(response){
  ...
  return (
    ...
    <div className="">
               ...
               <div className='p-5 h-screen  ' >
                <h1 className='text-3xl mb-2 uppercase tracking-wide font-semibold'   > lise des marques</h1>
                ...
                <table className='w-full'  >
                        ...
                        <tr>
                        <th className=' p-3 text-sm font-semibold tracking-wide text-left'  >marque de voiture</th>
                        ...
                        <tbody>
                          ...
                          {show.map(( type, i) =>
                                 <tr key={i}>
                                  <td className='p-3 text-sm text-black'> {type.nom_marque}</td>
                                ...
                                <td className='p-3 text-sm text-black'>
                                        ...
                                        <Link to={`/editmarque/${type.id}/`} className="p-1,5 text-sm font-medium uppercase tracking-wider
                                         text-green-500 
